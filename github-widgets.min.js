...
"/"+this.repo+"/"+this.type;return url+="?callback=gitHubWidgets.callback"},addScript:function(){url=this.buildUrl();"events"==this.type&&"undefined"==typeof window.githubSentences&&(body=document.getElementsByTagName("body")[0],js=document.createElement("script"),js.src="https://raw.github.com/adamjacobbecker/github-sentences/master/js/github-sentences.js",body.appendChild(js));body=document.getElementsByTagName("body")[0];jsonp=document.createElement("script");jsonp.src=url;body.appendChild(jsonp)},
callback:function(a){if(200<a.meta.status)return!1;a.data=a.data.slice(0,this.limit);for(i=0;i<a.data.length;i++)"commits"==this.type?this.renderCommit(a.data[i]):"repos"==this.type?this.renderRepo(a.data[i]):"events"==this.type&&this.renderEvent(a.data[i])},authorUrl:function(a){return a.replace("https://api.github.com/users/","https://github.com/")},repoUrl:function(a){return a.replace("https://api.github.com/repos/","https://github.com/")},renderCommit:function(a){commit_url="http://github.com/"+
this.org+"/"+this.repo+"/commits/"+a.sha;committer_url=this.authorUrl(a.committer.url);li=document.createElement("li");li.innerHTML='<a href="'+commit_url+'">'+a.commit.message+"</a>";li.innerHTML+=' by <a href="'+committer_url+'">'+a.commit.author.name+"</a>";li.innerHTML+=" - "+relativeDate(new Date(a.commit.author.date));this.el.appendChild(li)},renderRepo:function(a){li=document.createElement("li");li.innerHTML='<a href="'+a.html_url+'">'+a.name+"</a>";li.innerHTML+='<span class="meta"> - ';li.innerHTML+=
'<span class="stars">stars: '+a.watchers+"</span>";li.innerHTML+=', <span class="forks">forks: '+a.forks+"</span>";li.innerHTML+="</span>";this.el.appendChild(li)},renderEvent:function(a){li=document.createElement("li");li.innerHTML=githubSentences.convert(a);li&&this.el.appendChild(li)}};gitHubWidgets.addScript();
